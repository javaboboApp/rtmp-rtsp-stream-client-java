...
package com.river.libstreaming.hw;

import static com.river.libstreaming.hw.CodecManager.*;
...
public class EncoderDebugger {
	...
	private void debug() {
		...
		Codec[] encoders = findEncodersForMimeType(MIME_TYPE);
		Codec[] decoders = findDecodersForMimeType(MIME_TYPE);
